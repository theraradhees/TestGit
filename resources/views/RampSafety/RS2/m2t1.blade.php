...
<div class="a">
    <h1>Aerodrome Environment</h1>
    <hr>
</div>
<div class="b">
<p>
    There may be important unique aspects to the airport on which you work, such  as  dedicated  vehicle  lanes,  areas  not  visible  to  controllers  or nonstandard airport traffic patterns. Be aware and know the rules of your airport.
</p>
<br>
<h2>
    Aerodrome Layout
...
<p>
    Some of the area within the aerodrome are:
</p>
<ul>
    <li>
...
<br>
<h2>Equipment Restraint Area & Equipment Restraint Line</h2>
<p>
    The Equipment Restraint Area (ERA) is defined as the area of the apron bordered by a red line known as the Equipment Restraint Line–or otherwise indicated–in which an aircraft is parked during ground operations.
</p>
<br>
<p style="text-align: center"><b>Figure 1-1.Equipment Restraint Area & Equipment Restraint Line</b></p>
<p style="text-align: center"><b>Source:IATA Ground Operations Manual, 32nd edition, 2012</b></p>

<br>
<h2>Aerodrome Marking and Sign</h2>
<p>
    There  are  markings  and  signs  used  at  aerodromes,  which  provide directions and assist pilots and ramp operation personnel (especially drivers)in aerodrome operations. 
</p>
<h3>Marking</h3>
<p>
    Marking is a symbol or group of symbols displayed on the surface of the movement area in order to convey aero-nautical information.
</p>
<p>
    Different  markings  are  used  to  identify  different  areas  of  the aerodrome.  All  airside  users  must  be  familiar  with  the  airside markings. There are 3 (three) common markings are discussed.
</p>
<p>
    Some of the most common markings and signs are discussed.
</p>
<ol>
    <li>Runway Markings</li>
    <p>
        Runway markings shall be white. Runway markings vary depending on the type of operations conducted at the airport. Figure 1-2shows a  runway  that  is  approved  as  a  precision  instrument  approach runway and some other common runway markings.
    </p>
    <p>
    ...
    <p style="text-align: center">
        <b>Figure 1-2.Selected airport markings and surface lighting</b>
    </p>
    <p style="text-align: center"><b>Source:The Pilot’s Handbook of Aeronautical Knowledge, FAA, 2008</b></p>
    <br>

    <li>Taxiway Markings</li>
    <p>
        Aircraft use taxiways to transition from parking areas to the runway. Taxiways are identified by a continuous yellow center line stripe and may include edge markings to define the edge of the taxiway. This is usually done when the taxiway edge does not correspond with the edge of the pavement. If an edge marking is a continuous line, the paved shoulder is not intended to be used by an aircraft.
    </p>
    <p>
        If it is a dashed marking, an aircraft may use that portion of the pavement. Where a taxiway approaches a runway, there may be a holding position marker. These consist of four yellow lines (two solid and two dashed). The solid lines are where the aircraft is to hold. At some towered airports, holding position markings may be found on a runway.
    </p>
<div>
<p>
...
<ul>
    ...
    <li>ATC permission is always required to cross from the solid side to the dashed side at an aerodrome with an operating control tower</li>
    <li>
        When instructed to “Hold Short” always stop prior to first solid line of the runway holding position marking.
    </li>
    <p style="text-align: center">
       <b>Figure 1-3. Holding position marker</b> 
    </p>
</ul>
</div>
    <li>Other Markings</li>
    <p>
...
<h3>Sign</h3>
<p>
    There are six types of signs that may be found at airports. The more complex the layout of an airport, the more important the signs become to pilots. Figure 1-5 shows examples of signs, their purpose, and appropriate pilot action. The six types of signs are:
</p>
<ul>
    <li>
    ...
    <p style="text-align: center">
        <b>Figure 1-5. Aerodrome signs</b>
    </p>
    <p style="text-align: center"><b>Source:The Pilot’s Handbook of Aeronautical Knowledge, FAA, 2008</b></p>
</ul>
