...
<div style="text-align: justify">
    ...
    <ul>
        ...
        <li>Be familiar with good microphone operating techniques; </li>
        <p>Severe distortion of speech may arise from:</p>
        <ul>
            <li>Talking too close to the microphone </li>
            <li>Touching the microphone with the lips </li>
            <li>Holding the microphone or boom (of a combined Handset/microphone system). </li>
        </ul>
        <li>Use a normal conversational tone, and speak clearly and distinctly; </li>
        <li>Maintain an even rate of speech not exceeding 100 words per minute. When it is known that elements of the message will be written down by the recipient, speak at a slightly slower rate; </li>
        <li>Maintain the speaking volume at a constant level; </li>
        <li>A slight pause before and after numbers will assist in making them easier to understand; </li>
        <li>Avoid using hesitation sounds such as “er” </li>
...
<div style="text-align: justify"><br>
    ...
    <ul>
        ...
        <ul>
            <li>Unreadable</li>
            <li>Readable now and again</li>
            <li>Readable but with difficulties</li>
            <li>Readable</li>
            <li>Perfectly Readable</li>
        </ul>
    </ul>
    ...
    <ol>
        <li>Establishment and continuation of communications </li>
        <ul>
            <li>When establishing communications, a vehicle should use the full call sign of both the vehicle; and the aeronautical station. When a ground station wishes to broadcast information, the message should be prefaced by the call “ALL STATIONS”.</li>
            <li>When a vehicle wishes to broadcast information to other vehicles, the message should be prefaced by the call “ALL STATIONS”. </li>
        </ul>
        <li>No reply is expected to such general calls unless individual stations are subsequently called upon to acknowledge receipt. </li>
        <ul>
            <li>If there is doubt that a message has been correctly received, a repetition of the message shall be requested either in full or in part.</li>
        </ul>
    </ol>
    <p>Examples:</p>
    ...
    <ul>
        ...
        <li>If a correction can best be made by repeating the entire message, the operator shall use the phrase “CORRECTION I SAY AGAIN” before transmitting the message a second time.</li>
        <li>When it is considered that reception is likely to be difficult, important elements of the message should be spoken twice.</li>
        <li>The word “IMMEDIATELY” should only be used when immediate action is required for safety reasons</li>
    </ul>
    <p>
        Example:
    </p>
