<div style="text-align: justify">
    ...
    <ol type="A">
        ...
        <ol type="a">
            ...
            <p><u>Expansion ratio</u></p>
            <p>Foam expansion ratio and drainage rate of foam compounds equipment: </p>
            <ol type="i">
            ...
            <p><u>Drainage Time</u></p>
            <ol type="i">
                <li value="6">4 liters pressurized cylinder Tubes</li>
                <li>1000 ml measuring cup</li>
                <li>Stopwatch</li>
            </ol>
            <p></p>
        ...
        <ol>
            <li>Weigh empty of 1000 ml measuring cup; </li>
            <li>Enter the 6% foam concentrate about 60 ml into a measuring cup (foam concentrates taken from the vehicle tank); </li>
            <li>also enter 940 ml of water into a measuring cup (water from the tank vehicles tested) bringing the total number to 1,000 ml; </li>
            <li>Enter the measured fluid into the tube; </li>
        ...
        <p><u>Testing Drainage Time</u></p>
        <ol type="a">
            <li>Weigh empty of 1000 ml measuring cup </li>
            <li>insert the foam concentrate 6% 60 ml into a measuring cup (foam concentrates taken from the tank of the vehicle); </li>
            <li>Then insert water as well as 940 ml into a measuring cup (water from the tank vehicles tested foam concentrates) bringing the total number to 1,000 ml;</li>
            <li>insert the measured fluid into the tube and added with a pressure of 100 psi; </li>
            <li>Foam results from mixing in step no. 4, issued and accommodated in 1,000 ml measuring cup;</li>
            <li>Write down the time required from 25% foam turns into water. </li>
        </ol>
        <br>
        <p></p>
        <li>Record Data Testing Result</li>
    </ol>
    <br>
    <h2>pH Value test</h2>
    <p>
    ...
    <ol type="A">
        <li>Preparation</li>
        <ol type="a">
            <li>Prepare pH Value Test Equipment </li>
            <ul>
                <li>digital pH meter (electronic systems) and / or universal litmus paper; </li>
                <li>liquid buffer solution pH 4 and pH 7 as the calibration solution when using a pH meter with the required buffer </li>
            </ul>
            <li>Prepare Test Record Form </li>
            <li>Prepare Foam concentrate and Water to be tested </li>
        ...
        <ul>
            <li>Use digital pH meter </li>
            <ol>
                <li>Enter the gauges on fluid pH Buffer Solution 4 (for Calibration), pH digital meter shows the position 4 (standard: 3.5 to 4.5) </li>
                <li>Enter the gauges on fluid pH Buffer Solution 4 (for Calibration), pH digital meter shows the position 4 (standard: 3.5 to 4.5) </li>
                <li>Input gauges at pH 7 buffer solution, the pH meter will be addressed pH-7 (Standard: 6.5 - 7.5) </li>
                <li>Input gauges at pH 7 buffer solution, the pH meter will be addressed pH-7 (Standard: 6.5 - 7.5) </li>
                <li>Remove the gauge from a liquid buffer solution pH 7; </li>
                <li>Put gauges into the liquid foam concentrate to be measured and the pH digital meter will show the pH of foam concentrates; </li>
            </ol>
            <li>Use universal litmus paper </li>
            <ol>
                <li>Collect the solution to be tested in a container; </li>
                <li>Soak some of the universal litmus paper in the solution, then lift and set aside to dry; </li>
                <li>Compare discoloration on litmus paper with a standard color on the packaging for each pH.</li>
            </ol>
        </ul>
        <li>Record Data Testing Result</li>
    </ol>
    ...
    <ol type="A">
        <li>Preparation</li>
        <ol type="a">
            <li>Prepare Viscosity Test Equipment</li>
            <ul>
                <li>Viscometer Ostwald </li>
                <li>stopwatch </li>
            </ul>
            <li>Prepare Test Record Form </li>
            <li>Prepare Foam concentrate and Water to be tested </li>
        ...
        <li>Testing Procedures</li>
        <ol>
            <li>Put foam concentrate on the part that does not narrow tube; </li>
            <li>Incoming liquid foam will meet bubbling area; </li>
            <li>After a full-on part of the bubbly liquid will rise into the narrowed area, when the liquid touches on the areas marked green then a timing device (stop watch) is executed; </li>
            <li>Time permitted 1 seconds to reach the marked green on top; </li>
            <li>If the time it takes less than 1 second, then the foam concentrate too watery; </li>
            <li>If the time is more than 1 second then the foam concentrate too viscous. </li>
        </ol>
        <li>Record Data Testing Result </li>
    </ol>
    <br>
    ...
    <ol type="A">
        <li>Preparation</li>
        <ol type="a">
            <li>Prepare Sediment Test Equipment; </li>
            <ul>
                <li>2 unit Centrifuge tube </li>
            </ul>
            <li>Prepare Foam concentrate and Water to be tested.</li>
        ...
        <li>Testing Procedures </li>
        <ol>
            <li>Weigh the empty centrifuge tube </li>
            <li>Pour 6% foam concentrate into a tube centrifuge about 60 ml;</li>
            <li>Weigh tube and foam concentrate; </li>
            <li>Put the sample in a centrifuge bottle; </li>
            <li>Centrifuge operated at 1100 rpm rotation for 10 minutes;</li>
            <li>After centrifuge the tube will form two layers, the topmost pipette solution; </li>
    ...
    <ol type="A">
        ...
        <li>Testing Procedures</li>
        <ol>
            <li>Make a solution of 250 ml of foam concentrate comprising water = 15 ml + 235 ml of foam concentrates </li>
            <li>Mix a solution of water and foam concentrate; </li>
            <li>Use tensiometer to measure.</li>
        </ol>
        <li>Record Data Testing Result </li>
